...
`netreplay` is centered on networking work in JavaScript. The technical target is: Replay connection events through deterministic state-machine transitions.
...
The score is deterministic. The current threshold is 165. Risk has a penalty of 7, latency has a penalty of 2, and weight contributes a bonus of 4.

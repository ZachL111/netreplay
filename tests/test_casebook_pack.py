"""Regression checks for the netreplay casebook."""
...
from casebook.harness import assert_expected, netreplay_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(netreplay_summary(), assert_expected())
